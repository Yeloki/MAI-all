    ...
    class Rule:
        ...
        def apply(self, in_string):
            ...
            if DEBUG:
                ...
                print(f'By rule on line {self.id + 1}: "{self.repl_from}" -> "{self.repl_to}":')
                ...
                print(f'{"".join(old_string)} -> {"".join(string)}' + (' ==end' if self.last else ''))
...
if __name__ == '__main__':
    ...
    print(rb.apply(input('Enter string: ')))