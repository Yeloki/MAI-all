...
______________________________________________________________________________
  ...
  Functions available inside catch() and catchall:
    ...
    sxWalkTrace(func, p)  invoke func for all queue frames of the current ex.
...
// but it breaks autoformatting and so I delete it :P
...
struct SxTraceEntry {
  ...
  // program. Can be seen as a safer exit() because all "up-queue" catch/finally
